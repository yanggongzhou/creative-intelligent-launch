...
<div class="loadingBox">
  <div class="preloader">
    <div class="preloader__ring" v-if="saveLoading">
      <div class="preloader__sector">保</div>
      <div class="preloader__sector">存</div>
      <div class="preloader__sector">中</div>
      <div class="preloader__sector">请</div>
      <div class="preloader__sector">等</div>
      <div class="preloader__sector">待</div>
    ...
    <div class="preloader__ring" v-if="!saveLoading">
      ...
      <div class="preloader__sector">加</div>
      <div class="preloader__sector">载</div>
      <div class="preloader__sector">入</div>
      <div class="preloader__sector">中</div>
      <div class="preloader__sector">.</div>
      <div class="preloader__sector">.</div>
      <div class="preloader__sector">.</div>
